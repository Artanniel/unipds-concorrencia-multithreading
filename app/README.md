...
Initiate project
```shell script
quarkus create app br.com.artantech:app   --java=25   --extension='resteasy-reactive,resteasy-reactive-jackson,smallrye-health,hibernate-validator,vertx,smallrye-openapi'
...
Exercício 1: Execução de Tarefas CPU-Bound com FixedThreadPool

![Ex01](./src/main/resources/img/Ex01.png)
