package br.com.artantech.aula06;
...
public class Ex1ThenApplyVsThenCompose {
    ...
    public static void main(String[] args) {
        ...
        CompletableFuture<CompletableFuture<Profile>> nestedFuture = getUserById(101)
                .thenApply(user -> getProfileForUser(user));
        ...
        CompletableFuture<Profile> flatFuture = getUserById(102).thenCompose(user -> getProfileForUser(user));
